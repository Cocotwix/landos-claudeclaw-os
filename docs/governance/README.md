...
## Governance workflow
Before every major bundled implementation sprint, synchronize against: (1) Founder Vision, (2) Operating Charter, (3) Product Principles, (4) Decision Log, (5) Roadmap, (6) Architecture, (7) current implementation, (8) latest Build Journal entry.
