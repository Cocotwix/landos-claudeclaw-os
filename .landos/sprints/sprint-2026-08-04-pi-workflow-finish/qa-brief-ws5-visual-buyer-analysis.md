# Independent Browser-QA Brief — ws5-visual-buyer-analysis: Multi-view Visual Buyer Analysis, Overview summary, and PI placement
...
Operator outcome under test: Deal 81 shows one structured multi-view Visual Buyer Analysis (sections A-E) grounded in the combined accepted visual evidence in Property Intelligence, and a concise grounded Visual Buyer Summary on Overview with a control opening the full analysis; no fabricated facts, no legal conclusions, no superseded interpretation left visible.

## Requirements to disprove
- ws5-r1: One structured Visual Buyer Analysis with sections A-E, grounded in the combined multi-view evidence, is visible in V2 Property Intelligence.
- ws5-r2: A concise grounded Visual Buyer Summary appears on V2 Overview with a control opening the full analysis.
- ws5-r3: Conflicting visual evidence is reconciled; stronger evidence supersedes and no superseded interpretation remains visible.
- ws5-r4: No fabricated facts, legal conclusions, or guaranteed buildability/legal-access/septic/boundary/wetlands claims appear.
- ws5-r5: Existing page structure and visual system are preserved; compact comparable summary retained; no full comparable cards duplicated in PI.

## Required operator journey
1. Open V2 Overview for deal 81 and confirm the concise Visual Buyer Summary appears with physical character, main appeal, and top concern
2. Use its control to open/expand the full Visual Buyer Analysis in Property Intelligence
3. Confirm sections A-E are all present and grounded in the multi-view evidence
4. Confirm the corridor description matches the reconciled conclusion and no superseded interpretation remains
5. Confirm no fabricated facts, legal conclusions, or guaranteed buildability/access/septic/boundary/wetlands claims
6. Refresh both sections and confirm the analysis and summary persist

## Prohibited outcomes
- Must NOT occur: Analysis based on one aerial image alone or containing fabricated/legal/guaranteed claims
- Must NOT occur: Overview summary missing, unscannable, or lacking the expand control
- Must NOT occur: A superseded interpretation remains visible after stronger evidence
- Must NOT occur: Any section A-E missing from the full analysis
- Must NOT occur: Full comparable cards duplicated inside PI or the page redesigned
