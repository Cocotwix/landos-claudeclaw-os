# Independent Browser-QA Brief — ws1-conventional-resolution: Address plus APN and address-only autonomy
...
Operator outcome under test: A normal operator can submit either a complete address with APN or a valid address alone, walk away, and receive the most complete honest Deal Card LandOS can produce without developer intervention.

## Requirements to disprove
- ws1-r1: A fresh address plus APN intake normalizes the parcel, establishes one stable canonical subject, and autonomously settles to an honest Deal Card.
- ws1-r2: A fresh address-only intake resolves the parcel autonomously when public evidence can establish it and does not request a redundant APN.
- ws1-r3: County and ZIP work begin when their own prerequisites arrive while parcel-specific work waits for and then consumes the canonical subject.
- ws1-r4: Recovered evidence retains source, run, and subject provenance and drives bounded readiness reconciliation without churning satisfied work.
- ws1-r5: Property, Market, Seller, and Deal Intelligence become current and the visible Deal Card survives refresh without unintended research reruns.

## Required operator journey
1. Submit the address plus APN lead through New Lead and make no manual corrections
2. Observe subject establishment, capability scheduling, recovery, readiness, and intelligence until settled
3. Inspect the resulting Deal Card through normal operator navigation
4. Submit the address-only lead through New Lead and make no manual corrections
5. Confirm autonomous parcel resolution and downstream research
6. Hard refresh representative results and confirm persistence without unintended reruns

## Prohibited outcomes
- Must NOT occur: Address-only intake asks for an APN despite a viable autonomous resolution route
- Must NOT occur: Developer intervention is needed after submission
- Must NOT occur: County or ZIP work waits unnecessarily on parcel verification
- Must NOT occur: Deal Card intelligence is stale relative to admitted evidence
