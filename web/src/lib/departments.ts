...
export const DEPARTMENTS: DepartmentDef[] = [
  ...
  },
  {
    ...
    records: ['Market Snapshot', 'Market', 'County', 'Region', 'Territory', 'Market Report'],
    capabilities: ['Heat Map', 'Drill Deep', 'Quarterly retained snapshots', 'Sell-through & absorption', 'DOM & inventory', 'Growth signals'],
    surfaces: [
