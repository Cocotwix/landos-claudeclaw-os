...
function AssessorTaxRun({ dealId }: { dealId?: number }) {
    ...
    <div class="awv2-pi-note awv2-assessor-tax" data-testid="awv2-assessor-tax">
      ...
      {result && (
        <div class="awv2-assessor-tax-result" data-testid="awv2-assessor-tax-result">
          ...
          <div class="awv2-kv">
            <Kv k="Owner of record" v={assessorText(assessor.ownerOfRecord)} empty="Not published by the record" />
            <Kv k="Owner mailing address" v={assessorText(assessor.ownerMailingAddress)} empty="Not published by the record" />
            <Kv k="Assessed acreage" v={assessorText(assessor.assessedAcres)} empty="Not published by the record" />
            <Kv k="Total appraised value" v={assessorText(assessor.totalAppraisedValue)} empty="Not published by the record" />
            <Kv k="Taxable value" v={assessorText(assessor.taxableValue)} empty="Not published by the record" />
            <Kv k="Annual property tax" v={assessorText(tax.annualTaxAmount)} empty="Not published by the record" />
            <Kv k="Tax year" v={assessorText(tax.taxYear)} empty="Not published by the record" />
            <Kv k="Tax standing" v={assessorText(tax.standingLabel)} empty="Not established by a public source" />
            <Kv k="Last recorded sale" v={assessorText(transfer.lastSaleDate)} empty="Not published by the record" />
          </div>
